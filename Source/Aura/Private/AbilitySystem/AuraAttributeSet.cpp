...
UAuraAttributeSet::UAuraAttributeSet()
{
	...
	TagsToAttributes.Add(GameplayTags.Attributes_Primary_Intellect, GetIntellectAttribute);
...
void UAuraAttributeSet::OnRep_Intellect(const FGameplayAttributeData& OldIntellect) const
{
